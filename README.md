...
| [**Lirik Sanat Evi — Automation**](https://github.com/kyetim/liriksanatevi-otomasyon) | Desktop management system for a music school: students, teachers, scheduling, payments, reports, role-based access, SMS, backups | Electron · React · TypeScript · SQLite · Zod |
| [**Lirik Sanat Evi — Website**](https://github.com/kyetim/lirik-sanat-evi) | Website and lead generation for the same music academy | Next.js · TypeScript · Tailwind · Supabase · Vercel |
